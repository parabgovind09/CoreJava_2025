...
/*
 * Array is the fundamental data structure which allows us to store the multiple values of same data types into a single variable.
 * The elelments of an array are stored in contiguous memory location.
...
//    	The cloned array is a new object at the top level.
        ...
        cloned[0][0] = 99;
        System.out.println(original1.toString());
        System.out.println(cloned.toString());
        for (int i = 0; i < original1.length; i++) {
            System.out.print(original1[i].toString()+"\t");
        }
        for (int i = 0; i < cloned.length; i++) {
            System.out.print(cloned[i].toString()+"\t");
        }
        ...
        System.out.println("Checked Array: " + Arrays.deepEquals(original1,cloned));
        System.out.println(original1.toString());
        System.out.println(cloned.toString());
...
//      Modifying an element in cloned[0][0] affects the corresponding element in original[0][0]
        ...
        System.out.println("Checked Array: " + Arrays.deepEquals(original11,cloned1));
...
//        If you want a true deep copy of a 2D array (both the top-level and rows are fully independent), you need to manually clone each row.
        ...
        for (int i = 0; i < deepCopy.length; i++) {
            System.out.print(deepCopy[i].toString()+"\t");
        }
        ...
        System.out.println("\nChecked Array: " + Arrays.deepEquals(original111,deepCopy));
